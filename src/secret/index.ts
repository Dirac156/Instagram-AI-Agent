...
export const IGusername: string =
  process.env.IGusername || "default_IGusername";
export const IGpassword: string =
  process.env.IGpassword || "default_IGpassword";
...
export const TWITTER_API_CREDENTIALS = {
  ...
  accessToken:
    process.env.TWITTER_ACCESS_TOKEN || "default TWITTER_ACCESS_TOKEN",
  accessTokenSecret:
    process.env.TWITTER_ACCESS_SECRET || "default_TWITTER_ACCESS_SECRET",
  bearerToken:
    process.env.TWITTER_BEARER_TOKEN || "default_TWITTER_BEARER_TOKEN",
};

export const groqApiKey = process.env.GROQ_API_KEY;

export const geminiApiKey = process.env.GEMINI_API_KEY_1;
